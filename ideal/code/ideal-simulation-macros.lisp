...
; Mark, could you put in whatever needs to be exported. Basically
; include any functions defvars etc which need to be visible to a user
; at the top level (i.e someone who is using IDEAL as a black box).

(export '(importance-prob-of running-belief-of error-node))
