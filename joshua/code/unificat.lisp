  ...
  (cond ;; if they're eql, they unify with no special provision
	...
	((predicationp object1)
	 (if (predicationp object2)
	     ...
	     (unify-fail)))
	;; if they are both strings check if they match as strings, comparing with string=
	((and (stringp object1) (stringp object2) (string= object1 object2)))
	;; but strings can only match strings, so if either is a string, fail
	((or (stringp object1) (stringp object2))
	 (unify-fail))
	(t
