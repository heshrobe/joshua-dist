...
(defmethod current-justification ((pred cf-mixin))
  (justifications pred)
  )
...
;;; returns (mnemonic the-consequent true-support false-support unknown-support certainty)
(defmethod destructure-justification ((just cf-justification))
  (values (mnemonic just)
          (conclusion just)
          (true-support just)
          (false-support just)
          nil
          (certainty-factor just)
          ))
