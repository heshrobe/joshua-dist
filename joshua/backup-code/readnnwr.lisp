...
(defmacro predication-maker (&body form)
...
(eval-when (:compile-toplevel :execute :load-toplevel)
  ...
  (defclass separate-destination-joshua-module 
      (joshua-module-mixin common-lisp-user::separate-destination-module)
    ()))
...
(defun joshua-backquote-printer (stream object) (format stream "`~w" (cdr object)))
