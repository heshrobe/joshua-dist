...
(define-command (com-edit-definition :command-table editing :name t)
  ...
  #+(and allegro macosx)
  ;; Note that this only works on my machine with the appropriate
  ;; files in the appropriate places.
  (run-ascript "portable-lisp-environment:activate-emacs.scpt"  nil)
  )
